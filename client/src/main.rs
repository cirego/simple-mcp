//! MCP Client for simple-mcp project with stdio transport
//!
...
struct Args {
    ...
    #[arg(short, long, default_value = "./server/target/debug/simple-mcp-server")]
    server_cmd: String,
...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    if args.interactive {
        // Interactive mode
        info!("=== simple-mcp-client Interactive Mode ===");
        println!("=== simple-mcp-client Interactive Mode ===");
